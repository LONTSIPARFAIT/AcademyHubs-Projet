...
use App\Http\Controllers\Controller;        // Classe de base des contrôleurs Laravel
use App\Http\Resources\UserResource;        // Resource pour formater les réponses utilisateur
use App\Models\User;                         // Modèle User pour interagir avec la table users
use Illuminate\Http\Request;                  // Gère les requêtes HTTP entrantes
