          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full h-full">
            ...
            <div className="max-w-lg">
              ...
              <p className="text-lg text-blue-200 mb-8">
                Connectez-vous pour accéder à toutes nos formations gratuites, 
                projets concrets et opportunités de carrière au Cameroun.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white italic mb-2">
                      "Grâce à AcademyHub, j'ai décroché mon premier emploi en tant que développeur fullstack."
                    </p>
                    <p className="text-blue-200 text-sm">Kevin M., Douala</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white italic mb-2">
                      "La qualité des formations et le support de la communauté sont exceptionnels."
                    </p>
                    <p className="text-blue-200 text-sm">Amina B., Yaoundé</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200">Apprenants actifs</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">45+</div>
                <div className="text-sm text-blue-200">Cours gratuits</div>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-4 mb-8">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
                >
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-300"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-300 pr-10"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
