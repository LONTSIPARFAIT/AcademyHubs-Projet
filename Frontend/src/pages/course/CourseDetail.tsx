  ...
  const allCourses = [
    ...
    },
    {
      ...
      syllabus: [
        {
          week: 1,
          title: 'Introduction à PHP et Laravel',
          lessons: 5,
          topics: ['Installation de Laravel', 'Composer', 'Structure MVC'],
          duration: '8 heures'
        },
        {
          week: 2,
          ...
          lessons: 4,
          topics: ['Routing', 'Controllers', 'Views Blade'],
          duration: '7 heures'
        },
        {
          week: 3,
          title: 'Bases de Données avec Eloquent',
          lessons: 6,
          topics: ['Migrations', 'Models', 'Relations Eloquent'],
          duration: '9 heures'
        }
      ],
      requirements: [
      ...
      outcomes: [
        ...
        'Gérer des bases de données avec Eloquent',
