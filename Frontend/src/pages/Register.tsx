...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.password) {
      ...
      newErrors.password = 'Doit contenir lettres et chiffres';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Ici, vous ajouterez votre logique d'inscription réelle
  ...
  const handleSocialRegister = (provider: string) => {
    ...
    // Ici vous ajouterez la logique d'inscription avec le provider
  };

  const passwordStrength = () => {
    if (!formData.password) return { score: 0, label: 'Faible', color: 'bg-red-500' };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      {/* Container principal qui prend tout l'écran */}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8">
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                ...
                >
                  ...
                  <span className="font-medium">S'inscrire avec GitHub</span>
                </button>
              </div>
